...
const About = () => {
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", marginTop: "80px", padding:"100px"}}>

      <h1 style={{ fontSize: "40px", color: "#FFFFFF" }}>About Me</h1>
      <p style={{ color: "#707070", fontSize: "20px" }}>I’m a passionate developer who enjoys creating clean, modern web experiences and continuously learning new skills to grow professionally.</p>
      ...
      <div className='About-container'>
        ...
        <div style={{ width: "700px" }}>
          <p style={{ fontSize: "20px", lineHeight: "2.3", color: "#959595" }}>
          ...
          <button className='Download' style={{ backgroundColor: "#FA6E00" }}>DownLoad CV</button>
        </div>
      </div>

      <div style={{ display: "flex", flexWrap:"wrap", gap:"200px", color: "#959595", alignItems:"center", justifyContent:"center" ,marginTop:"100px"}}>
